      ...
      <main className="flex-1 container mx-auto px-4 py-8 md:px-6 md:py-12 space-y-12">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm h-full min-h-[500px]">
              <h2 className="text-xl font-bold mb-4">Module Graph</h2>
              <ModuleGraph />
            </section>
          </div>
        </div>
